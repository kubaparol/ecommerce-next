...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null }> } | null };

export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null }> };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null }> } | null };
...
export type CollectionGetBySlugQuery = { collections: Array<{ name: string, image: { id: string, url: string }, products: Array<{ id: string, name: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> }> };

export type CollectionsGetListQueryVariables = Exact<{ [key: string]: never; }>;


export type CollectionsGetListQuery = { collections: Array<{ id: string, slug: string, name: string }> };
...
export type OrdersGetByEmailQuery = { orders: Array<{ id: string, total: number, orderItems: Array<{ id: string, total: number, product?: { name: string, price: number, images: Array<{ url: string }> } | null }> }> };
...
export type ProductsCategoryGetQuantityQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']['input']>;
}>;
...
export const ProductsCategoryGetQuantityDocument = new TypedDocumentString(`
...
export const ProductsGetQuantityDocument = new TypedDocumentString(`
